export type TemplateCategory = "toy" | "yubiley" | "bola" | "universal";
...
export const templates: TemplateMeta[] = [
  { id: "luxury-gold", name: "Luxury Gold", palette: ["#171310", "#C7A253", "#F5EFE0"], category: "yubiley", badge: "premium",
